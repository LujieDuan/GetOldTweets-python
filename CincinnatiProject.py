...
def main(search_keyword):
	try:
		...
		csvwriter.writerow(['username','date','retweets','favorites','text','geo','mentions','hashtags','id','permalink'])

		print('Searching...\n')

		def receiveBuffer(tweets):
			for t in tweets:
				csvwriter.writerow([t.username, t.date.strftime("%Y-%m-%d %H:%M"), t.retweets,t.favorites, t.text, t.geo, t.mentions, t.hashtags, t.id, t.permalink])
			csvfile.flush()
